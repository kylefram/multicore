...
The important note here is in the box: "This applies even in cases where the Intrinsic Data Dependency might be perceived to be a false dependency." 
...
\begin{lstlisting}
    ...
    herd7 sub.litmus > logs/q2/c_2.txt
\end{lstlisting}

TODO: Comment / sanity check