...
\lstinputlisting[caption={MessagePassing}, label={lst:MP}]{../ctests/raq2.c}
...
Here is the compiled code (full compilation in appendix):\newline

\includegraphics[width=8cm]{../logs/q3/images/reader2.png}\newline
\includegraphics[width=8cm]{../logs/q3/images/writer2.png}\newline
\includegraphics[width=8cm]{../logs/q3/images/main2.png}
